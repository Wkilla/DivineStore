...
const Search = () => {
  ...
  return (
    <>
      ...
      {searchTerm && products.length !== 0 && <h2 className="text-center text-6xl my-10 max-lg:text-4xl max-sm:text-2xl max-sm:my-5 text-accent-content">Отображение результатов для "{searchTerm}"</h2>}
      {products.length === 0 && searchTerm && <h2 className="text-center text-6xl my-10 max-lg:text-4xl max-sm:text-2xl max-sm:my-5 text-accent-content">Никаких результатов по запросу найдено не было "{searchTerm}"</h2>}
